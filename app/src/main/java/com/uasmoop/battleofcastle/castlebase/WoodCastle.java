...
public class WoodCastle extends BaseCastle{
    public WoodCastle(int cavalryCount, int infantryCount, int archerCount, int catapultCount, UnitClass hero1, UnitClass hero2) {
    ...
    public void printTotalStat() {
        ...
        totalSkillATK = (archerStat.getSkill_atk() * ArcherCount) + (cavalryStat.getSkill_atk() * CavalryCount)  + (catapultStat.getSkill_atk() * CatapultCount) + (infantryStat.getSkill_atk() * InfantryCount);        float totalBonusATK = (float)((archerStat.getAtk() * ArcherCount) * archerBonus)  + (float)(((cavalryStat.getAtk() * CavalryCount)) * cavalryBonus)  + (float)((catapultStat.getAtk() * CatapultCount) * catapultBonus) + (float)((infantryStat.getAtk() * InfantryCount) * infantryBonus);
