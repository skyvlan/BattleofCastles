...
public class SteelCastle extends BaseCastle{
    public SteelCastle(int cavalryCount, int infantryCount, int archerCount, int catapultCount, UnitClass hero1, UnitClass hero2) {
