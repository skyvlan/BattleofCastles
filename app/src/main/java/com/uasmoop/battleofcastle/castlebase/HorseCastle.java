...
public class HorseCastle extends BaseCastle{
    public HorseCastle(int cavalryCount, int infantryCount, int archerCount, int catapultCount, UnitClass hero1, UnitClass hero2) {
